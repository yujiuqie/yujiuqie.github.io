---
title: "Xcode - 使用条件搜索替换和正则搜索替换"
date: 2020-08-08
abbrlink: Note_00203_20161109
categories:
- iOSNotebook
tags:
- Xcode
...
| 序号 | 录入时间 | 录入人 | 备注 |
|:--------:|:--------:|:--------:|:--------:|
| 1 | 2016-11-09 | [Alfred Jiang](https://yujiuqie.github.io) | - |
...
![](/assets/iosnotebook/Images/Image_00203_00001.png)

举例：查找 AFNetworking 中下面方法，使用条件搜索

![](/assets/iosnotebook/Images/Image_00203_00002.png)

![](/assets/iosnotebook/Images/Image_00203_00003.png)

#### 2. 正则搜索

进入 Xcode 搜索标签页，选择 `Find -> Regular Expression` , 点击搜索栏，输入查询正则表达式即可

![](/assets/iosnotebook/Images/Image_00203_00004.png)
...
* [正则表达式 - 在 iOS 开发中使用正则表达式](Note_00091_20151223.html)