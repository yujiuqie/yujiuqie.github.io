---
title: "Xcode - 真机调试问题 (Could not locate device support files)"
date: 2020-08-08
abbrlink: Note_00210_20161215
categories:
- iOSNotebook
tags:
- Xcode
...
| 序号 | 录入时间 | 录入人 | 备注 |
|:--------:|:--------:|:--------:|:--------:|
| 1 | 2016-12-15 | [Alfred Jiang](https://yujiuqie.github.io) | - |
...
在[开发证书配置](Note_00131_20160119.html)正常的情况下，发生真机无法联调问题，一般是由于 Xcode 支持的设备版本与真机系统版本不一致导致的
...
* [专题 - iOS 应用证书、真机调试与发布 Appstore](Note_00131_20160119.html)