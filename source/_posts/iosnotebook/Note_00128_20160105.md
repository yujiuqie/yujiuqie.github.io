---
title: "Auto Layout -  约束冲突断点调试方法"
date: 
abbrlink: Note_00128_20160105
categories:
- iOSNotebook
tags:
- Auto Layout
...
| 序号 | 录入时间 | 录入人 | 备注 |
|:--------:|:--------:|:--------:|:--------:|
| 1 | 2016-01-05 | [Alfred Jiang](https://yujiuqie.github.io) | - |
...
![](/assets/iosnotebook/Images/Image_00128_00001.png)

通过添加以下设置，可以观察到全部的 *UIView* 层级关系以及 *AMBIGUOUS LAYOUT* 提示（*AMBIGUOUS LAYOUT* 即为约束冲突或不完善位置），更好的定位约束冲突

![](/assets/iosnotebook/Images/Image_00128_00002.png)
