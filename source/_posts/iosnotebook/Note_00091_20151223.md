---
title: "正则表达式 - 在 iOS 开发中使用正则表达式"
data: 2015-03-02
abbrlink: Note_00091_20151223
categories:
- iOSNotebook
tags:
- 正则表达式
...
6. [stackoverflow - How to validate an IP address with regular expression in Objective-C?](https://stackoverflow.com/questions/1679152/how-to-validate-an-ip-address-with-regular-expression-in-objective-c)

### 五、详细内容

##### 正则表达式的相关语法

![正则表达式的相关语法](/assets/iosnotebook/Images/Image_00091_00001.jpg)
...
* [JavaScript - 正则表达式介绍](../JavaScript/JavaScript_00002_20160130.html)
...
| 3 | 2016-11-15 | [Alfred Jiang](https://yujiuqie.github.io) | - |
| 4 | 2020-08-13 | [Alfred Jiang](https://yujiuqie.github.io) | - |
